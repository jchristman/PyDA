...
class PyDAInterface(Frame):
    ...
    def disassembleFile(self, file_name):
        if not file_name == '':
            ...
            if isinstance(disassembly, CommonProgramDisassemblyFormat): #TODO: make functions/strings clear between loading files
                ...
                for s in disassembly.strings:
                    self.parent.addCallback(self.strings_listbox.insert, (END, s.name))
